...
- **Main:** Sección del contenedor para los elementos centrales: logo, barra de búsqueda, iconos y botones.
...
### Link a demo
En el siguiente link puedes ver mi proyecto terminado: [Copia de Google](https://copiadegoogle-one.vercel.app/)
